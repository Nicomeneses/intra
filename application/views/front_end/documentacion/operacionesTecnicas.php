...
$('#formoperacionestecnicas').submit(function(){

var formElement = document.querySelector("#formoperacionestecnicas");
...
if($('.categoria').val()==""){
	...
	if($('#userfile').val()==""){
	    ...
	    $.ajax({
	        url: $('.formoperacionestecnicas').attr('action')+"?"+$.now(),  
	        type: 'POST',
	        data: formData,
	        cache: false,
	        processData: false,
	  	...
	  	/*	beforeSend:function(){
	        ...
	        success: function (data) {
				...
				if(data.res == 0){
			     ...
			     setTimeout(function(){window.location="operacionestecnicas"} ,1000);   
			    } 
	        }
   	   });
    }
 ...
 $.post($(this).attr('action')+"?"+$.now(), $(this).serialize(), function(data) {
    ...
    if(data.res == 1){
		Materialize.toast(data.msg, 1000,'',function(){
			window.location="operacionestecnicas";
		});
    }   
  }, 'json');
  return false;  
...
<div id="modal1" class="modal modal-fixed-footer">
	<div class="modal-content">
	  <center><h4>Nuevo Archivo</h4></center>
	  ...
	  <div class="progress2"></div>
        <?php echo form_open_multipart('formoperacionestecnicas', array('id'=>'formoperacionestecnicas','class'=>'formoperacionestecnicas')); ?>
		  <div class="row">
		  <div class="input-field">
			    ...
			    <select class="browser-default categoria" name="categoria" id="categoria">
			      ...
			      <option value="Redes domiciliarias">Redes domiciliarias</option>
			      <option value="Planta externa">Planta externa </option>
			      <option value="Planta Interna">Planta Interna </option>
			      <option value="Despacho">Despacho</option>
			      <option value="Logistica y bodegas">Logistica y bodegas</option>
  ...
  <div class="col s12 m12 l12"> 
	...
	<div class="row jumbotron">
		<div class="col l12 jumbotron_title">
			<div class="col s10">
				<h3>Operaciones T&eacute;cnicas</h3>
			</div>
			<div class="col s2">
	...
	<div class="changepass_form">
		...
		<thead>
		  <tr> 
		  	  ...
		  	  <th data-field="categoria">Subcategor&iacute;a</th>
